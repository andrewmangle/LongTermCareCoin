...
//$personal->newAccount('2d640748ba99a141ce14069c9e87c6c57757609da40e3b0b65f562a727ad393c', 'ExD3RkHaguDiFb24mVMRiHhQDjBN');
//$scaccount = '0xc557b845BDd408d2A32047c9f36535467e0a9BF8';
$personal->newAccount('ExD3RkHaguDiFb24mVMRiHhQDjBN', function ($err, $unlocked) {
	if ($err !== null) {
		echo 'Error During Unlock Account: ' . $err->getMessage();
		return;
	}
	if ($unlocked) {
        	echo 'SC account is created unlocked!' . $unlocked;
	} else {
	    echo 'SC  account is not unlocked'. $unlocked;
	}
}); 
