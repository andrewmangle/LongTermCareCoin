...
$scaccount = '0xce2a7ee3a109a3c310251d535e5b87b6c579173a';
$personal->unlockAccount($scaccount, 'ExD3RkHaguDiFb24mVMRiHhQDjBN', function ($err, $unlocked) {
	if ($err !== null) {
		echo 'Error During Unlock Account: ' . $err->getMessage();
		return;
	}
	if ($unlocked) {
        	echo 'SC account is unlocked! ' . $scaccount;
	} else {
	    echo 'SC  account is not unlocked' . $scaccount;
	}
}); 
